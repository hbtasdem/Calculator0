...
const styles = StyleSheet.create({
  ...
  loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#242e24' },
  content: { padding: 20 },
  title: { marginBottom: 10, color: '#fff' },
  description: { marginBottom: 20, fontSize: 14, color: '#141a14' },
  emptyState: { padding: 40, alignItems: 'center' },
  emptyText: { color: '#666', textAlign: 'center' },
  categoryCard: { backgroundColor: '#141a14', padding: 15, borderRadius: 12, marginBottom: 15, borderWidth: 1, borderColor: '#333' },
  categoryHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
  categoryName: { fontSize: 18, color: '#ecfad4' },
  locationText: { fontSize: 12, color: '#888' },
  editBtn: { backgroundColor: '#333', padding: 6, borderRadius: 4 },
  editBtnText: { color: '#ecfad4', fontSize: 12 },
  amountText: { fontSize: 16, fontWeight: 'bold', marginVertical: 8, color: '#ecfad4' },
  progressBg: { height: 10, backgroundColor: '#333', borderRadius: 5, overflow: 'hidden' },
  progressFill: { height: '100%', backgroundColor: '#ecfad4' },
  quickAddRow: { flexDirection: 'row', gap: 10, marginTop: 15 },
  quickBtn: { flex: 1, backgroundColor: '#3d4f3d', padding: 8, borderRadius: 6, alignItems: 'center' },
  ...
  addButton: { backgroundColor: '#3d4f3d', padding: 15, borderRadius: 10, alignItems: 'center', marginTop: 10 },
  addButtonText: { color: '#ecfad4', fontWeight: 'bold' },
  addForm: { backgroundColor: '#1E1E1E', padding: 15, borderRadius: 12, borderWidth: 1, borderColor: '#333' },
  input: { backgroundColor: '#3d4f3d', color: '#fff', padding: 10, borderRadius: 6, marginBottom: 10, borderWidth: 1, borderColor: '#444' },
  typeRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 15 },
  typeBtn: { padding: 8, borderRadius: 6, borderWidth: 1, borderColor: '#444', backgroundColor: '#3d4f3d' },
